...
def getSearchFilters(field_information=None, type=None):
    ...
    filters = {
        ...
        'date': ['Is', 'Is Not', 'Is Emtpy', 'Is Not Empty', 'Before', 'After', 'Between', 'Yesterday', 'Today',
                 ...
                 'Last N Days', 'Next 7 Days', 'Next 30 Days', 'Next 60 Days', 'Next 90 Days', 'Next 120 Days',
                 'Next N Days', 'Last Week', 'This Week', 'Next Week', 'Current and Previous Week',
                 'Current and Next Week', 'Last N weeks', 'Next N Weeks', 'Last Week', 'This Month', 'Next Month',
                 'Last Month', 'Current and Previous Month', 'Current and Next Month', 'Last N Months', 'Next N Months',
                 'Last Year', 'This Year', 'Next Year', 'Current and Previous Year', 'Current and Next Year',
                 'Last N Years', 'Next N Years'],
        'datetime-local': ['Is', 'Is Not', 'Is Emtpy', 'Is Not Empty', 'Before', 'After', 'Between', 'Yesterday',
                           'Today',
                           'Tomorrow', 'Last 7 Days', 'Last 30 Days', 'Last 60 Days', 'Last 90 Days', 'Last 120 Days',
                           'Last N Days', 'Next 7 Days', 'Next 30 Days', 'Next 60 Days', 'Next 90 Days',
                           'Next 120 Days',
                           'Next N Days', 'Last Week', 'This Week', 'Next Week', 'Current and Previous Week',
                           'Current and Next Week', 'Last N weeks', 'Next N Weeks', 'Last Week', 'This Month',
                           'Next Month',
                           'Last Month', 'Current and Previous Month', 'Current and Next Month', 'Last N Months',
                           'Next N Months',
                           'Last Year', 'This Year', 'Next Year', 'Current and Previous Year', 'Current and Next Year',
                           'Last N Years', 'Next N Years', 'on', 'at'],
